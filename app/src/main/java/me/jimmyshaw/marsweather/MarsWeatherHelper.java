...
// is created.
public class MarsWeatherHelper extends Application
{
    private RequestQueue mRequestQueue;
    private static MarsWeatherHelper mInstance;

    // This is a generic token used to identity the request.
    public static final String TAG = MarsWeatherHelper.class.getSimpleName();
    ...
    public static synchronized MarsWeatherHelper getInstance()
    {
        return mInstance;
    }
